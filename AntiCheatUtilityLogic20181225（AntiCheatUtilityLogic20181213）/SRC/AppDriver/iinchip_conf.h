 ...
 */
//#define __DEF_IINCHIP_MAP_BASE__  0x80000000
#define __DEF_IINCHIP_MAP_BASE__  ((uint32)0xE1000000)
...
//   #define SOCKET_REG_BASE   __DEF_IINCHIP_MAP_BASE__ + 0x0400 /**< The base address of SOCKET_REG */   
   #define SOCKET_REG_BASE   ((uint32)0xE1000400)
#else
   #define COMMON_REG_BASE     0                               
   #define SOCKET_REG_BASE     0x0400                          
#endif

#define SOCKET_REG_SIZE    0x80     // SOCKET Regsiter Count per Channel
