...
SDA_EXT	sd_struct	sd_info;					//SD卡信息

//初始化
SDA_EXT	void SDCardInit(void);
SDA_EXT void MCI_Handler(void);

SDA_EXT	INT8U ReadSDCardBlock(INT32U blockaddr, INT8U *recbuf);
SDA_EXT INT8U ReadSDCardMultiBlock(INT32U blockaddr, INT32U blocknum,INT8U *recbuf);
SDA_EXT	INT8U WriteSDCardBlock(INT32U blockaddr, INT8U *sendbuf);
SDA_EXT INT8U WriteSDCardMultiBlock(INT32U blockaddr, INT32U blocknum,INT8U *sendbuf);
