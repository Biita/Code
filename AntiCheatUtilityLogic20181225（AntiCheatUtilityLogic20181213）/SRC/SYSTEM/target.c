...
#define WAITWEN1        0x02                                            /* 配置EMCStaticWaitWen1       */
#define WAITOEN1        0x02                                            /* 配置EMCStaticWaitOen1       */ 
#define WAITRD1         0x02                                            /* 配置EMCStaticWaitRd1        */
#define WAITPAGE1       0x00                                            /* 配置EMCStaticWaitPage1      */
#define WAITWR1         0x04                                            /* 配置EMCStaticWaitWr1        */
#define WAITTURN1       0x00                                            /* 配置EMCStaticWaitTurn1      */
...
#define WAITWEN3        0x04                                            /* 配置EMCStaticWaitWen3       */
#define WAITOEN3        0x04                                            /* 配置EMCStaticWaitOen3       */ 
...
#define STATICCFG1  	( BCFG_16DEF | BCFG1 ) //cqy
...
void TargetResetInit (void)
{
	...
	EMCStaticConfig3    = STATICCFG3;
    EMCStaticWaitWen3	= WAITWEN3;
    EMCStaticWaitOen3	= WAITOEN3;
    EMCStaticWaitRd3	= WAITRD3;
    EMCStaticWaitPage3	= WAITPAGE3;      
    EMCStaticWaitWr3    = WAITWR3;
    EMCStaticWaitTurn3  = WAITTURN3;
