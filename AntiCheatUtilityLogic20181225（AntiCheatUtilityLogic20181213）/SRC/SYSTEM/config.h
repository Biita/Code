...
#include	"DEFConfig.h"
#include	"DEFConfigConst.h"
#include	"DEFConfigErrCode.h"
...
#define		UBR_921600	921600		//串口波特率
...
#define Fcclk           (Fosc * 16)                                     /* 不高于208MHz                 */
...
#endif
#if Fcclk > 208000000
   #error  "Fcclk couldn't be higher than 208MHz"                        
#endif
