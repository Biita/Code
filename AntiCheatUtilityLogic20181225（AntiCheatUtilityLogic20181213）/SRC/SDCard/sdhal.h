...
/* GPIO_00 (0x01 << 10)卡写保护检测引脚   改新版GPI_00*/
#define  SD_WP_BIT				(0x01 << 0)		
#define  SD_WP_STATUS()  		(P3_INP_STATE & SD_WP_BIT)				/* 读取 WP 口的状态   */
...
extern INT32U DMA_Init(INT32U ChannelNum, INT32U DMAMode, INT32U SrcAddr, INT32U DstAddr, INT32U TransferSize);
...
#define MCLKDIV_SLOW	0x90	    // 0xff
#define MCLKDIV_NORMAL	0x01		//	 0xff
